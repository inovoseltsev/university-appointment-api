...
public class UserRegistrationDto {
    ...
    @Schema(example = "fake_illianovoseltsev@illia.com", required = true, description = "\"fake_\" prefix is used to register user without email activation (you can use real email instead)")
